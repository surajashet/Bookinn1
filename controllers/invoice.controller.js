...
export const getAllInvoices = async (req, res) => {
  try {
    ...
    if (payment_state) {
      query = query.eq("payment_state", payment_state);
    }
    if (user_id) {
...
// Download invoice (mock function - you can implement PDF generation later)
export const downloadInvoice = async (req, res) => {
  try {
    ...
    // You can later implement actual PDF generation
    res.json({
      success: true,
