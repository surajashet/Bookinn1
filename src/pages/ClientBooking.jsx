        ...
        handler: async (response) => {
          ...
          try {
            ...
            if (verifyData.success) {
              ...
              navigate(`/client/bookings/${booking_id}/invoice`);
            } else {
              ...
              <div style={{
                ...
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "8px" }}>
                  ...
                  <span style={{ color: "#6B6560", fontSize: "13px" }}>
                    ₹{(priceDetails.totalPrice * 0.12 + 150).toFixed(0)}
                  </span>
                </div>
                <div style={{
                  ...
                  <span style={{ color: "#4A7C72", fontSize: "20px" }}>
                    ₹{(priceDetails.totalPrice + priceDetails.totalPrice * 0.12 + 150).toLocaleString("en-IN")}
                  </span>
                </div>
              </div>
            )}
